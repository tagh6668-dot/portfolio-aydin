document.addEventListener('DOMContentLoaded', () => {
    ...
    function handleMohsenResponse() {
        ...
        setTimeout(() => {
            ...
            appendMessage('سپاسگزارم جناب کاظمی عزیز! تمایل و انتخاب شما دریافت شد. بسیار خرسندم از اینکه سلیقه شما با طراحی‌های مدرن و استانداردهای اتولایه بنده همسو است. پیشنهاد می‌کنم یک جلسه کوتاه ۵ الی ۱۰ دقیقه‌ای صوتی داشته باشیم تا دقیقاً صفحات مد نظرتان را نهایی کنیم و کار طراحی وایدفریم‌ها را از همین امروز استارت بزنیم. فردا چه ساعتی برای شما مناسب است؟', 'received');
        }, 1500);
    }
